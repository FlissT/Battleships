...
class MyWindow(Gtk.Window):
    def __init__(self):
        ...
        bbox1.add(self.button1)
        bbox1.add(self.button2)
        bbox1.add(self.button3)
        bbox2.add(self.button4)
        bbox2.add(self.button5)
        bbox2.add(self.button6)
        bbox3.add(self.button7)
        bbox3.add(self.button8)
        bbox3.add(self.button9)
